...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:hls:GN_inference:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: GN_inference_0, and set properties
  set GN_inference_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:GN_inference:1.0 GN_inference_0 ]
...
\
  ...
  connect_bd_net -net GN_inference_0_result [get_bd_pins GN_inference_0/result] [get_bd_pins comblock_0/reg0_i]
  connect_bd_net -net GN_inference_0_result_ap_vld [get_bd_pins GN_inference_0/result_ap_vld] [get_bd_pins comblock_0/reg1_i]
  connect_bd_net -net comblock_0_fifo_data_o [get_bd_pins GN_inference_0/input_r_TDATA] [get_bd_pins comblock_0/fifo_data_o]
  connect_bd_net -net comblock_0_fifo_valid_o [get_bd_pins GN_inference_0/input_r_TVALID] [get_bd_pins comblock_0/fifo_valid_o] [get_bd_pins comblock_0/fifo_we_i]
  connect_bd_net -net comblock_0_reg0_o [get_bd_pins GN_inference_0/ap_start] [get_bd_pins comblock_0/reg0_o]
  connect_bd_net -net comblock_0_reg1_o [get_bd_pins comblock_0/fifo_re_i] [get_bd_pins comblock_0/reg1_o]
  connect_bd_net -net rst_ps8_0_299M_peripheral_aresetn [get_bd_pins GN_inference_0/ap_rst_n] [get_bd_pins comblock_0/axil_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_299M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins comblock_0/fifo_clear_i] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins GN_inference_0/ap_clk] [get_bd_pins comblock_0/axil_aclk] [get_bd_pins comblock_0/fifo_clk_i] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_299M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
