...
\
  ...
  connect_bd_net -net GN_inference_0_result [get_bd_pins GN_inference_0/result] [get_bd_pins comblock_0/reg2_i]
  connect_bd_net -net Net [get_bd_pins GN_inference_0/input_r_TDATA] [get_bd_pins comblock_0/fifo_data_i] [get_bd_pins comblock_0/fifo_data_o]
  ...
  connect_bd_net -net comblock_0_reg1_o [get_bd_pins GN_inference_0/ap_start] [get_bd_pins comblock_0/reg1_o]
  connect_bd_net -net comblock_0_reg2_o [get_bd_pins comblock_0/fifo_re_i] [get_bd_pins comblock_0/reg2_o]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins GN_inference_0/ap_clk] [get_bd_pins comblock_0/axil_aclk] [get_bd_pins comblock_0/fifo_clk_i] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins GN_inference_0/ap_rst_n] [get_bd_pins comblock_0/axil_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
