...
|---------------|-----------------|----------|
| Project Name | Project Name | Lab08-04 |
|  | Project location | `/home/student/Documents/cursoML2025/labs/lab08/04-UDMA/` |
...
9. Dado que necesitas crear una aplicación para usar tu diseño, debes exportar el hardware generado al entorno Vitis. Haz click en: **File -> Export -> Export Hardware**. Dado que hay algo de lógica en la parte PL del Zynq, el bitstream respectivo debe incluirse en la tarea de exportación. Por lo tanto, asegúrate de marcar la casilla **Include bitstream**. Luego haz click en **Next**.
...
| Wizard Screen | System Property | Settings | 
|---------------|-----------------|----------|
...
| | Architecture: | 32-bit |
| Click **Next** | | |  
| Templates | Available Templates: | **UDMA Server** | 
| Click **Finish** | | | 
...
2. Construye la parte de aplicación del proyecto haciendo clic derecho en **app_inference**, luego selecciona **Build Project**.

>**Nota:** La aplicación UDMA asignará por defecto la dirección `192.168.1.10` a la placa de desarrollo ZedBoard.
...
1. Conecta la ZedBoard a tu computadora a través de 2 cables micro-USB, conecta el cable de Ethernet, y la fuente de alimentación.

2. Enciende la placa de desarrollo ZedBoard.


## 4.2. Ejecución de la Aplicación en la placa de desarrollo ZedBoard

En Vitis, en la vista Explorer, haz clic derecho en **app_inference**, luego selecciona **Run -> Run As -> Launch on Hardware (System Debugger)** para reconfigurar el FPGA y ejecutar el código compilado en el PS. Si todo sale bien, deberías ver el siguiente mensaje en el terminal. **Asegúrate de que la conexión se haya establecido**.

En este punto, has configurado un entorno completo de hardware y software para ejecutarse en el ZedBoard SoC. Ahora procederás con la interacción remota del dispositivo que has creado utilizando UDMA a través de Ethernet.


Sigue las instrucciones en el Jupyter Notebook para interactuar con el diseño de hardware en el SoC.
