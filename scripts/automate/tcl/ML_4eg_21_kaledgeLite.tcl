...
# --- Wrapper generation (robusto) ---
# 1) Generar wrapper desde el .bd del proyecto (mejor usar el mismo objeto/relativo)
make_wrapper -files [get_files ${design_name}.bd] -top

# 2) Buscar el wrapper generado (no hardcodear path)
#    Tip: el wrapper suele quedar en myproj/project_1.gen/sources_1/bd/<bd>/hdl/<bd>_wrapper.v
set wrapper_glob [glob -nocomplain "myproj/project_1.gen/sources_1/bd/${design_name}/hdl/${design_name}_wrapper.v"]

# fallback: buscar en cualquier subdir por si cambia el layout
...
# --- fin wrapper generation ---

# (Optional) Launch synthesis, implementation, and bitstream generation
reset_run synth_1
reset_run impl_1
...
write_hw_platform -fixed -include_bit -force -file ../myproj/${design_name}-v2-4ge21.xsa
#write_hw_platform -fixed -include_bit -force -file ../myproj/ML_4eg_21_wrapper-3b11.xsa
